...
class TestMessages(unittest.TestCase):
    ...
    def test_prelogin_generation_fedauth(self):
        ...
        tds._main_session.send_prelogin(login)
        template = (
            b"\x12\x01\x00\x65\x00\x00\x00\x00\x00\x00"
            + b"\x24\x00\x06\x01\x00\x2a\x00\x01\x02\x00\x2b\x00\x0c\x03"
            + b"\x00\x37\x00\x04\x04\x00\x3b\x00\x01\x06\x00\x3c\x00\x01\x07\x00\x3d\x00\x20\xff"
            + struct.pack(">l", pytds.intversion)
            + b"\x00\x00\x02MSSQLServer\x00\x00\x00\x00\x00\x00"
            + b"\x01"
