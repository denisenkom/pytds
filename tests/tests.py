...
class TestMessages(unittest.TestCase):
    ...
    def test_prelogin_generation(self):
        ...
        template = (b'\x12\x01\x00:\x00\x00\x00\x00\x00\x00' +
                    ...
                    b'\x00-\x00\x04\x04\x001\x00\x01\xff\x01\x06\x00\x00' +
    ...
    def test_login_generation(self):
        ...
        self.assertEqual(
            ...
            b'\x00\x00\x06\x01' +  # client library ver
            b'd\x00\x00\x00' +  # pid
        ...
        self.assertEqual(
            ...
            b'100100de00000100' +
            b'c6000000' +
            b'')
        sock._sent = b''
