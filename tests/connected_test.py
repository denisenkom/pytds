...
@pytest.mark.parametrize(
    ...
    [
        ...
        (pytds.tds_types.VarCharType(size=10), u''),
        (pytds.tds_types.VarCharType(size=10), u'testtest12'),
        (pytds.tds_types.VarCharType(size=10), None),
        (pytds.tds_types.VarCharType(size=4000), u'x' * 4000),
        (pytds.tds_types.VarCharMaxType(), u'x' * 10000),
        ...
        (pytds.tds_types.NVarCharMaxType(), u'x' * 10000),
