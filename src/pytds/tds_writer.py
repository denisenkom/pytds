...
from pytds.tds_base import _uint_be, _byte, _smallint_le, _usmallint_le, _usmallint_be, _int_le, _uint_le, _int8_le, \
    _uint8_le, _header
...
class _TdsWriter:
    ...
    """
    def __init__(self, transport: tds_base.TransportProtocol, bufsize: int, tds_session):
